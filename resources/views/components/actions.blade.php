    ...
    <x-lv::drop-down>
      ...
      @foreach ($actions as $action)
        @if ($action->renderIf($item))
          <a href="#!" wire:click.prevent="executeAction('{{ $action->id }}', '{{ $item->id }}', true)" class="group flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900">
