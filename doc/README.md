...
- [Advanced usage](laravel-views.md)
...
These directives are fine for a dev environment, however, if you want to use your own Tailwindcss or Alpinde.js setup, you can [disable these assets](./laravel-views.md#including-assets) from being loaded with the Laravel views directive.
# First table view
This is a basic usage of a table view, you can [read the full table view documentation ](table-view.md)
...
[Read the full table view documentation ](table-view.md)

## Advanced usage

[Read the advanced laravel-views documentation ](laravel-views.md)
